...
{   //DML işlemlerinin yapılabilmesi için oluşturduğumuz, template kullanarak hem user hem entry hem de diğer enetities (varlıklar) için kod tekrarından kaçınarak generic(genel) repository oluşturduk
