...
public class GetUserEntriesQueryHandler : IRequestHandler<GetUserDetailQuery, UserDetailViewModel>
{
    private readonly IUserRepository _userRepository;
    private readonly IMapper _mapper;

    public GetUserEntriesQueryHandler(IUserRepository userRepository, IMapper mapper)
    {
