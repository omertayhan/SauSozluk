...
public class GetEntryDetailQueryHandler : IRequestHandler<GetEntryCommentsQuery, PagedViewModel<GetEntryCommentsViewModel>>
{
    private readonly IEntryCommentRepository _entryCommentRepository;

    public GetEntryDetailQueryHandler(IEntryCommentRepository entryCommentRepository)
    {
